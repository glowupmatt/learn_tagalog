...
const navigationItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2h4a1 1 0 011 1v2a1 1 0 01-1 1h-1v12a2 2 0 01-2 2H8a2 2 0 01-2-2V8H5a1 1 0 01-1-1V5a1 1 0 011-1h2z" />
      </svg>
    )
  },
  {
...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  // Close menu when route changes (not on initial render)
  useEffect(() => {
    if (previousPathnameRef.current !== null && previousPathnameRef.current !== pathname && isOpen) {
      onClose();
    }
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden overscroll-behavior-y-contain" style={{
          ...
          <div className="p-3 sm:p-4 border-t border-gray-700 mt-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-blue-400 flex items-center">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
